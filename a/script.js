...
document.addEventListener('DOMContentLoaded', () => {
    ...
    boxes.forEach((box, index) => {
      box.addEventListener('mouseenter', () => {
        ...
        viewer.style.backgroundImage = `url('${index + 1}.png')`;
...
document.addEventListener("DOMContentLoaded", function() {
    var animations = [
        {id: 'cam', path: 'ani/cam.json'},
        {id: 'tennis', path: 'ani/tenis.json'},
        {id: 'cake', path: 'ani/cake.json'},
        {id: 'picture', path: 'ani/picture.json'},
        {id: 'plant2', path: 'ani/plant2.json'},
        {id: 'ploging', path: 'ani/ploging.json'},
        {id: 'cook', path: 'ani/cook.json'},
        {id: 'triangle', path: 'ani/triangle.json'},
        {id: 'sing', path: 'ani/sing.json'},
        {id: 'book', path: 'ani/book.json'},
        {id: 'hat', path: 'ani/hat.json'},
        {id: 'plant', path: 'ani/plant.json'},
        {id: 'cut', path: 'ani/cut.json'},
    ];
...
$('.bg-inner').on('mousemove', function(e) { 
    ...
    $('.mouse-follower').css({
        ...
        "background-image": "url('mouse.svg')", // 원래의 배경 이미지를 복원
        "border-radius": "100%",
